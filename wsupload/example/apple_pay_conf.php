...
define('PRODUCTION_MERCHANTIDENTIFIER', 'merchant.com.example.warsawtest');
...
define('PRODUCTION_DOMAINNAME', 'www.wsground.com');


define('PRODUCTION_CURRENCYCODE', 'TWD');	// https://en.wikipedia.org/wiki/ISO_4217
define('PRODUCTION_COUNTRYCODE', 'TW');		// https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
define('PRODUCTION_DISPLAYNAME', 'My Awesome Test Shop');
